...
def main():
    ...
    for source_image in source_images:
        ...
        print('PSNR : {:.3f}'.format(PSNR(image_tensor.cpu().numpy(), encoded_images.cpu().numpy())))
        print('MSE : {:.3f}'.format(MSE(image_tensor.cpu().numpy(), encoded_images.cpu().numpy())))
