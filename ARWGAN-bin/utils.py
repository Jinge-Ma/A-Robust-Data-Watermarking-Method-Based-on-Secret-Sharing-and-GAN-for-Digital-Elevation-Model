...
def save_checkpoint(model: ARWGAN, experiment_name: str, epoch: int, checkpoint_folder: str):
    ...
    # # Print the shape of each layer's weights for encoder, decoder, and discriminator
    # print("Encoder Weights Shape:")
    # for name, param in model.encoder_decoder.encoder.named_parameters():
    #     print(f"{name}: {param.shape}")
    #
    # print("\nDecoder Weights Shape:")
    # for name, param in model.encoder_decoder.decoder.named_parameters():
    #     print(f"{name}: {param.shape}")
    #
    # print("\nDiscriminator Weights Shape:")
